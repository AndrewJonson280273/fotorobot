...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.list_frame.setGeometry(QtCore.QRect(0, 220, 481, 551))
        ...
        self.back_button = QtWidgets.QPushButton(parent=self.eyes_tab)
        self.back_button.setGeometry(QtCore.QRect(0, 770, 93, 28))
        self.back_button.setObjectName("back_button")
        self.next_button = QtWidgets.QPushButton(parent=self.eyes_tab)
        self.next_button.setGeometry(QtCore.QRect(390, 770, 93, 28))
        self.next_button.setObjectName("next_button")
        self.page_number_label = QtWidgets.QLabel(parent=self.eyes_tab)
        self.page_number_label.setGeometry(QtCore.QRect(90, 776, 301, 20))
        ...
        self.graphicsView.setGeometry(QtCore.QRect(25, 40, 500, 700))
        self.graphicsView.setObjectName("graphicsView")
        self.widget = QtWidgets.QWidget(parent=self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(330, 720, 197, 90))
        self.widget.setObjectName("widget")
        self.img_layout = QtWidgets.QVBoxLayout(self.widget)
        ...
        self.img_layout.addLayout(self.horizontalLayout)
        self.pushButton_3 = QtWidgets.QPushButton(parent=self.widget)
        self.pushButton_3.setObjectName("pushButton_3")
        self.img_layout.addWidget(self.pushButton_3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.page_number_label.setText(_translate("MainWindow", "Страница 2/6"))
        ...
        self.pushButton.setText(_translate("MainWindow", "Увеличить"))
        self.pushButton_2.setText(_translate("MainWindow", "Уменьшить"))
